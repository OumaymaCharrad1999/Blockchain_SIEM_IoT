...
assets := []Asset{
	{ID: "1", Severity: 1, Facility: 5, Owner: "Tomoko", Message: "Failed login"},
	{ID: "2", Severity: 5, Facility: 5, Owner: "Brad", Message: "Uncorrect Password"}
...
func (s *SmartContract) CreateAsset(ctx contractapi.TransactionContextInterface, id, message string, severity int, owner string, facility int) error {
//	func (s *SmartContract) CreateAsset(ctx contractapi.TransactionContextInterface, id, color string, size int, owner string, facility int) error {
...
func (s *SmartContract) UpdateAsset(ctx contractapi.TransactionContextInterface, id, color string, size int, owner string, facility int) error {
	exists, err := s.AssetExists(ctx, id)
	if err != nil {
		return err
	}
